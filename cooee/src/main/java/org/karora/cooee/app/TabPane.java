...
implements Pane, PaneContainer {
    ...
    public static final String PROPERTY_TAB_TITLE_INSETS = "tabTitleInsets";
    ...
    /**
     * Gets the <code>Insets</code> around the tab title.
     * 
     * @return the insets around the tab title
     */
    public Insets getTabTitleInsets() {
    	return (Insets) getProperty(PROPERTY_TAB_TITLE_INSETS);
    }

    /**
     * Sets the <code>Insets</code> around the tab title.
     * 
     * @param newValue the new tab title insets
     */
    public void setTabTitleInsets(Insets newValue) {
    	setProperty(PROPERTY_TAB_TITLE_INSETS, newValue);
    }       
}
