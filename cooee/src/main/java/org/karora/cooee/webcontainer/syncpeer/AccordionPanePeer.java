...
implements ComponentSynchronizePeer, ImageRenderSupport, LazyRenderContainer, PropertyUpdateProcessor {
    ...
    public static final String PROPERTY_LAZY_RENDER_ENABLED 
            = "org.karora.cooee.webcontainer.AccordionPanePeer.lazyRenderEnabled";

    /**
     * Service to provide supporting JavaScript library.
     */
    public static final Service ACCORDION_PANE_SERVICE = JavaScriptService.forResource("Cooee.AccordionPane",
            "/org/karora/cooee/webcontainer/resource/js/AccordionPane.js");
