...
public class PngEncoder {
    ...
    implements Filter {
        ...
        /**
         * @see org.karora.cooee.webcontainer.image.PngEncoder.Filter#filter(byte[], byte[], byte[], int)
         */
        public void filter(byte[] filterOutput, byte[] currentRow, byte[] previousRow, int outputBpp) {
        ...
        /**
         * @see org.karora.cooee.webcontainer.image.PngEncoder.Filter#getType()
         */
        public int getType() {
    ...
    implements Translator {
        ...
        /**
         * @see org.karora.cooee.webcontainer.image.PngEncoder.Translator#translate(byte[], int)
         */
        public void translate(byte[] outputPixelQueue, int row) {
