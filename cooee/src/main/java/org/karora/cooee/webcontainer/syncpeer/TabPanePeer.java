...
import org.karora.cooee.webcontainer.LazyRenderContainer;
...
implements ComponentSynchronizePeer, ImageRenderSupport, LazyRenderContainer, PropertyUpdateProcessor {
     ...
     */
    public static final String PROPERTY_LAZY_RENDER_ENABLED = "org.karora.cooee.webcontainer.TabPanePeer.lazyRenderEnabled";
    
    /**
     * Service to provide supporting JavaScript library.
     */
    public static final Service TAB_PANE_SERVICE = JavaScriptService.forResource("Echo2Extras.TabPane",
            "/org/karora/cooee/webcontainer/resource/js/TabPane.js");
    ...
    /**
     * @see org.karora.cooee.webcontainer.LazyRenderContainer#isRendered(org.karora.cooee.webcontainer.ContainerInstance, 
     *      org.karora.cooee.app.Component, org.karora.cooee.app.Component)
     */
    ...
    private void renderInitDirective(RenderContext rc, TabPane tabPane, String targetId) {
        ...
        Extent tabHeight = (Extent) tabPane.getRenderProperty(TabPane.PROPERTY_TAB_HEIGHT);
        if (tabHeight != null) {
        	initElement.setAttribute("header-height", String.valueOf(ExtentRender.toPixels(tabHeight, 32)));
        }
        Extent tabWidth = (Extent) tabPane.getRenderProperty(TabPane.PROPERTY_TAB_WIDTH);
        if (tabWidth != null) {
        	initElement.setAttribute("header-width", String.valueOf(ExtentRender.toPixels(tabWidth, 32)));
        }
        Insets tabTitleInsets = (Insets) tabPane.getRenderProperty(TabPane.PROPERTY_TAB_TITLE_INSETS);
        if (tabTitleInsets != null) {
        	initElement.setAttribute("header-padding", InsetsRender.renderCssAttributeValue(tabTitleInsets));
        }     
