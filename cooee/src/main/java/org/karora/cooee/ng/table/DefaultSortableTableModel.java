...
public class DefaultSortableTableModel extends AbstractTableModel implements SortableTableModel {
	...
	/**
	 * @see org.karora.cooee.ng.table.SortableTableModel#getSortDirective(int)
	 */
	...
	/**
	 * @see org.karora.cooee.ng.table.SortableTableModel#setSortDirective(int, int)
	 */
	...
	/**
	 * @see org.karora.cooee.ng.table.SortableTableModel#toUnsortedModelRowIndex(int)
	 */
	...
	/**
	 * @see org.karora.cooee.ng.table.SortableTableModel#toSortedViewRowIndex(int)
	 */
	...
	/**
	 * @see org.karora.cooee.ng.table.SortableTableModel#sortByColumn(int, int)
	 */
	...
	/**
	 * @see org.karora.cooee.ng.table.SortableTableModel#getCurrentSortColumn()
	 */
