...
public class ReflectionKit {
	 ...
	 * 
	 * @see org.karora.cooee.ng.util.reflect.ReflectionKit.MemberClassComparator
	 */
	public static class ClassMemberComparator extends MemberClassComparator {
		/**
		 * @see org.karora.cooee.ng.util.reflect.ReflectionKit.MemberClassComparator#compare(java.lang.Object, java.lang.Object)
		 */
		public int compare(Object o1, Object o2) {
			if (o1 == null || o2 == null) {
				return compareForNullness(o1, o2);
	...
	public static boolean hasMethod(String methodName, Class[] paramTypes, Class returnType, Object targetObj) {
		...
		Method[] methods = getMethods(targetObj.getClass(), Object.class, new MethodSearchCriteria() {
			/**
			 * @see org.karora.cooee.ng.util.reflect.ReflectionKit.MethodSearchCriteria#isMethodOK(java.lang.Class,
