...
import org.karora.cooee.app.DelegateFocusSupport;
...
public class ComboBox extends DropDown implements DelegateFocusSupport {
	...
	/**
	 * @see org.karora.cooee.app.text.TextComponent#getText()
	 */
	...
	/**
	 * @see org.karora.cooee.app.text.TextComponent#setText(java.lang.String)
	 */
