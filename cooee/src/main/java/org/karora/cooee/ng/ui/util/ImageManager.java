...
import org.karora.cooee.webcontainer.image.AwtImageService;
import org.karora.cooee.webcontainer.image.StreamImageService;
 ...
 * <p>
 * The base org.karora.cooee.webcontainer.image.ImageRenderSupport does not do a
...
public class ImageManager implements RenderState {
	...
	static {
		...
		DEFAULT_HANDLER = new ImageReferenceURIHandler() {
			/**
			 * @see org.karora.cooee.ng.ui.util.ImageManager.ImageReferenceURIHandler#getImageURI(ContainerInstance,
			 *      ImageReference)
			 */
			public String getImageURI(ContainerInstance containerInstance, ImageReference imageReference) {
