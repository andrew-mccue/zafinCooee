...
import org.karora.cooee.ng.util.ComponentTracker;
...
public class PopUp extends AbleComponent implements Expandable {
	...
	public static final ImageReference DEFAULT_TOGGLE_ICON = new ResourceImageReference("/org/karora/cooee/ng/resource/images/popup_normal_icon.gif",
			new Extent(15), new Extent(16));

	public static final ImageReference DEFAULT_TOGGLE_ROLLOVER_ICON = new ResourceImageReference(
			"/org/karora/cooee/ng/resource/images/popup_rollover_icon.gif", new Extent(15), new Extent(16));

	public static final ImageReference DEFAULT_TOGGLE_PRESSED_ICON = new ResourceImageReference(
			"/org/karora/cooee/ng/resource/images/popup_pressed_icon.gif", new Extent(15), new Extent(16));
	...
	/**
	 * @see org.karora.cooee.ng.able.Expandable#getExpansionGroup()
	 */
	...
	/**
	 * @see org.karora.cooee.ng.able.Expandable#getExpansionModel()
	 */
	...
	/**
	 * @see org.karora.cooee.ng.able.Expandable#isExpanded()
	 */
	...
	/**
	 * @see org.karora.cooee.ng.able.Expandable#setExpanded(boolean)
	 */
	...
	/**
	 * @see org.karora.cooee.ng.able.Expandable#setExpansionGroup(org.karora.cooee.ng.model.ExpansionGroup)
	 */
	...
	/**
	 * @see org.karora.cooee.ng.able.Expandable#setExpansionModel(org.karora.cooee.ng.model.ExpansionModel)
	 */
