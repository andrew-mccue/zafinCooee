...
/**
 * <code>StringPeer</code> maps Strings to Strings.  Simple
 * really.
 */
public class StringPeer extends AbstractCssPropertyPeer {
	...
	protected Object getObject(CssObjectIntrospector ci, String propertyValue) {
		// the value that comes in may be quoted
		// and therefore we need to "dequote" it to follow CSS
		// behaviour
		String[] tokens = tokenize(propertyValue,"");
		return tokens[0];
	}
	
	/**
	 * @see org.karora.cooee.ng.stylesheet.propertypeer.AbstractCssPropertyPeer#getString(org.karora.cooee.ng.stylesheet.CssObjectIntrospector, java.lang.Object)
	 */
