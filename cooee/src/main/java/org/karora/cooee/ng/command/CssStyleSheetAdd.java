...
/**
 * <code>CssStyleSheetAdd</code> allows a external stylesheet URI to be to be
...
public class CssStyleSheetAdd extends CssStyleDecl {

	private String styleSheetURI;

	/**
	 * Constructs a <code>CssStyleSheetAdd</code> command with the URI of the
	 * style sheet to add (eg something like "/css/swisho/whizbang.css"
	 * 
	 * @param styleSheetURI -
	 *            the URI of the style sheet
	 */
	public CssStyleSheetAdd(String styleSheetURI) {
		super();
		this.styleSheetURI = styleSheetURI;
	}

	/**
	 * @return the URI of the external style sheet.
	 */
