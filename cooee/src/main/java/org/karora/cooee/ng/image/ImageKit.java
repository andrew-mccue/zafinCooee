...
import org.karora.cooee.ng.util.collections.ConcurrentReaderHashMap;
...
public class ImageKit {
	...
	public static ImageReference getTransparentImageRef(int width, int height) {
		return new ResourceImageReference("/org/karora/cooee/ng/ui/resource/images/transparent1x1.gif", new Extent(width), new Extent(height));
	}
