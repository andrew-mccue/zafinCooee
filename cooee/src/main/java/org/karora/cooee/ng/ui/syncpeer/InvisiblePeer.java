...
public class InvisiblePeer extends AbstractEchoPointPeer {
	...
	public void renderHtml(RenderingContext rc, Node parentNode, Component component) {
		//
		// this peer does nothing because it really is invisible.  Tihs
		// allows non visible components to have their required
		// synch peer.  All such non visibel components can use this
		// peer.
		rc = null;
	}
}
