...
/**
  ...
  * a node.  The listener is informed after the event has happened.  
  * To be notified as a tree node is being expanded or collapsed,
  * look at TreeWillExpandListener.
  *
  */
