...
/**
 * This button model uses <code>ActionEventEx</code> objects when it raise
 * events.
 * 
 */
public class DefaultButtonModelEx extends DefaultButtonModel implements ButtonModelEx {
	...
	public void doAction() {
		doAction(ActionEventEx.METAKEY_NONE);
	}

	/**
	 * @see org.karora.cooee.ng.model.ButtonModelEx#doAction(int)
	 */
	public void doAction(int metaKeyInfo) {
		fireActionPerformed(new ActionEventEx(this, getActionCommand(), metaKeyInfo));
	}
}
