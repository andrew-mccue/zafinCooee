...
public class TreeTableCellPeer extends AbstractEchoPointPeer implements ActionProcessor {
	...
	public void renderHtml(RenderingContext rc, final Node parentNode, Component component) {
		...
		TreeRenderer.EventSupportCallBack callback = new TreeRenderer.EventSupportCallBack() {
			/**
			 * @see org.karora.cooee.ng.ui.syncpeer.TreeRenderer.EventSupportCallBack#onExpandoCell(org.karora.cooee.webrender.output.CssStyle,
			 *      org.w3c.dom.Element, org.karora.cooee.ng.Tree, java.lang.Object)
			 */
			...
			/**
			 * @see org.karora.cooee.ng.ui.syncpeer.TreeRenderer.EventSupportCallBack#onNodeComponentCell(org.karora.cooee.webrender.output.CssStyle,
			 *      org.w3c.dom.Element, org.karora.cooee.ng.Tree, java.lang.Object)
			 */
			...
			/**
			 * @see org.karora.cooee.ng.ui.syncpeer.TreeRenderer.EventSupportCallBack#onNodeIconCell(org.karora.cooee.webrender.output.CssStyle,
			 *      org.w3c.dom.Element, org.karora.cooee.ng.Tree, java.lang.Object)
			 */
			public String onNodeIconCell(RenderingContext rc, CssStyle cssStyle, Element cellElement, Tree tree, Object treeNode, TreePath treeNodePath) {
				return addSelectEvents(rc, cssStyle, treeTableCell, tree, treeNode, treeNodePath, "icon");
			}

			/**
			 * @see org.karora.cooee.ng.ui.syncpeer.TreeRenderer.EventSupportCallBack#onNodeTextCell(org.karora.cooee.webrender.output.CssStyle,
			 *      org.w3c.dom.Element, org.karora.cooee.ng.Tree, java.lang.Object)
			 */
			public String onNodeTextCell(RenderingContext rc, CssStyle cssStyle, Element cellElement, Tree tree, Object treeNode, TreePath treeNodePath) {
				return addSelectEvents(rc, cssStyle, treeTableCell, tree, treeNode, treeNodePath, "text");
			}

			/**
			 * @see org.karora.cooee.ng.ui.syncpeer.TreeRenderer.EventSupportCallBack#onTreeRow(org.karora.cooee.webrender.output.CssStyle,
			 *      org.w3c.dom.Element, org.karora.cooee.ng.Tree)
			 */
	...
	private String addSelectEvents(RenderingContext rc, CssStyle cssStyle, Component component, Tree tree, Object treeNode, TreePath treeNodePath, String cellType) {
		String eventElementId = createEventId(component, tree, cellType, "select", treeNode, treeNodePath);
