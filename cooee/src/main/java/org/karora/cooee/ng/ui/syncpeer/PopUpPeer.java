...
import org.karora.cooee.ng.ui.util.StaticImageService;
...
public class PopUpPeer extends AbstractEchoPointContainerPeer implements PropertyUpdateProcessor {
	public static final Service POPUP_DEFAULT_TOGGLE_IMAGE = StaticImageService.forResource("EPNG.PopUpDefaultToggleImage",
			"/org/karora/cooee/ng/resource/images/dropdown_arrow.gif", new Extent(7), new Extent(7));

	/**
	 * Service to provide supporting JavaScript library.
	 */
	public static final Service POPUP_SERVICE = JavaScriptService.forResource("EPNG.PopUp", "/org/karora/cooee/ng/ui/resource/js/popup.js");
