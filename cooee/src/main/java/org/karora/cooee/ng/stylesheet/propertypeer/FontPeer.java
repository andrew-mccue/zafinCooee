...
/**
 * <code>FontPeer</code> is used to create Font objects
 */
public class FontPeer extends AbstractCssPropertyPeer {
	...
	/**
	 * @see org.karora.cooee.ng.stylesheet.propertypeer.AbstractCssPropertyPeer#canConvert(CssObjectIntrospector, java.lang.String)
	 */
	protected boolean canConvert(CssObjectIntrospector ci, String propertyValue) {
		return FontKit.isFont(propertyValue);
	}

	/**
	 * @see org.karora.cooee.ng.stylesheet.propertypeer.AbstractCssPropertyPeer#getObject(CssObjectIntrospector, java.lang.String)
	 */
	protected Object getObject(CssObjectIntrospector ci, String propertyValue) {
		return FontKit.makeFont(propertyValue);
	}
	
	/* --- string conversion --- */
	protected String getString(CssObjectIntrospector ci, Object object) {
		Font value = (Font) object;
		return FontKit.makeFontString(value);
	}
