...
public class TitleBar extends AbleComponent implements Expandable  {
	...
	public static final ImageReference DEFAULT_LEFT_EXPANDED_ICON = new ResourceImageReference("/org/karora/cooee/ng/resource/images/horz_expand_on.gif",new Extent(17), new Extent(14)); 
	/** The default image used as the left icon */
	public static final ImageReference DEFAULT_LEFT_ICON = new ResourceImageReference("/org/karora/cooee/ng/resource/images/horz_expand_off.gif",new Extent(17), new Extent(14)); 
