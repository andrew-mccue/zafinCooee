...
/*
 * This file was taken from the Echo2 project and made part of the EchoPoint 
 * project on the 16/5/05 and is hence Copyright (C) 2002-2005 NextApp, Inc.
 * Unfortunately the TriCellTable class is not public and hence needs to be 
 * copied not re-used  
 */
...
public class TriCellTable {
     ...
     */
    public TriCellTable(Document document, String id, int orientation0_1, Extent margin0_1) {
        this(document, id);
     ...
     */
    public TriCellTable(Document document, String id, int orientation0_1, Extent margin0_1, int orientation01_2, Extent margin01_2) {
        this(document, id);
     ...
     */
    public Element getTdElement(int index) {
     ...
     *         pixels.
     */
    public Element getMarginTdElement(int index) {
