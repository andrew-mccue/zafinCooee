...
public interface AutoLookupModel {
	...
	public static class DefaultEntry implements Entry {
		...
		/**
		 * @see org.karora.cooee.ng.text.AutoLookupModel.Entry#getSortValue()
		 */
		public String getSortValue() {
			return sortValue;
		}
		...
		/**
		 * @see org.karora.cooee.ng.text.AutoLookupModel.Entry#getValue()
		 */
		public String getValue() {
			return value;
		}
		...
		/**
		 * @see org.karora.cooee.ng.text.AutoLookupModel.Entry#getXhtmlFragment()
		 */
		public XhtmlFragment getXhtmlFragment() {
			return xhtml;
		}
