 ...
 * versa.
 * 
 * @see org.karora.cooee.ng.stylesheet.CssPropertyPeer
 */
public class CssPropertyPeerLoader {

	private static final String PROPERTY_PEERS_PATH = "META-INF/org/karora/cooee/ng/stylesheet/CssPropertyPeers.properties";
