...
import org.karora.cooee.ng.template.TemplateTextSubstitution;
import org.karora.cooee.ng.ui.resource.Resources;
import org.karora.cooee.ng.ui.template.TemplateCompiler;
import org.karora.cooee.ng.ui.template.TemplateCompilerLoader;
...
import org.karora.cooee.ng.util.collections.ExpiryCache;
...
public class TemplatePanelPeer extends AbstractEchoPointContainerPeer {
	...
	public static final Service TEMPLATE_JS_SERVICE = JavaScriptService.forResource("EPNG.TemplatePanel",
			"/org/karora/cooee/ng/ui/resource/js/templatepanel.js");
	static {
