...
/**
 * <code>TreeWillExpandListener</code> is notified when a <code>Tree</code>
 * is about to expand or collapse a node. The listener has a chance therefore to
 * throw an <code>ExpandVetoException</code> to prevent the operation.
 */
